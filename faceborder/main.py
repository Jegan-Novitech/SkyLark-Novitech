...
while 1:
    ...
    for (box, pred) in zip(locs, preds):
        ...
        # frame
        cv2.putText(blended1, temperature, (50, 50),cv2.FONT_HERSHEY_SIMPLEX, 0.45, color, 2)
        cv2.putText(blended1, label, (startX, startY - 10),cv2.FONT_HERSHEY_SIMPLEX, 0.45, color, 2)
        cv2.rectangle(blended1, (startX, startY), (endX, endY), color, 2)
