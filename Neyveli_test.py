...
#                     print('excibit')
                    ...
                    try:
                        ...
                        if(name!="Unknown"):
                            ...
                            detail="'"+reader_name+time_stamp+date_stamp+str(r_name)+"00000'"
                            conn1 = sqlite3.connect('attendance.db')
                            c1 = conn1.cursor()

                            c1.execute("INSERT INTO temp_attendance (Detail, temperature, Mask) VALUES (%s,%s,%s)"% (detail,temp_list[6],str(m_id)))
                            print('inserted')
