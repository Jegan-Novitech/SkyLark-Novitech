...
def face_train(Name='nothing'):
        #global data
        try:
                data,shape=face.create_model(db_path="/home/pi/Desktop/deepface_check/dataset", model_name="Facenet")
        except:
                data=''
        return data,shape
...
#             name=face.recognize(data,blended1)
            name=face.analysis(img=blended1,db_path="/home/pi/Desktop/deepface_check/dataset", model_name="Facenet", distance_metric = 'cosine',model=data,input_shape=shape, enable_face_analysis = False)
...
#                             subprocess.Popen("python3 audio.py --model 'High Temperature Detected Not Allowed'",shell=True)
                            ...
                            try:
                                ...
                                self.sl1.config(text="        ", fg='RED', bg='#333579')
                                self.sl4.config(text=" ", fg='#ffffff', bg='#333579')
